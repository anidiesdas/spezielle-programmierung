...
sed -i.bak "s|image: .*frontend.*|image: ${FRONTEND_IMAGE}|g" k8s/frontend-deployment.yaml
...
echo ""
echo "App erreichbar unter: http://supplement.localhost"
echo "AI Service: http://ai.localhost"
echo "Data Service: http://data.localhost"